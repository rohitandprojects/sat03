"use client";
import { getCategory } from "@/app/lib/firebase/categoryOther/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/categoryOther/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/other');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
