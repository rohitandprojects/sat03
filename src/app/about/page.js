				...
				<div className="container">
					<div className="row">
						<div className="col-12">
							...
							<div className="view-job-offers text-center" ref={jobOfferRef}><Link href={'#'} className="view-job-offers-link position-relative" data-bs-toggle="modal" data-bs-target="#careersModal">Apply Now</Link></div>
						</div>
					</div>
				</div>
			</div>
